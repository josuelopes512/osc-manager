	...
	questions: {
		create: [
			...
			},
			{
				...
				checkBox: [
					{
						choice: "Falta de alinhamento entre expectativas de OSCs e alunos",
						order: 1,
					},
					{
						choice: "Dificuldade dos alunos em aplicar a teoria na prática",
						order: 2,
					},
					{
						choice: "Limitações de tempo e recursos para orientar os alunos",
						order: 3,
					},
